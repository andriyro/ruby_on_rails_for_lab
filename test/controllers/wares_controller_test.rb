...
class WaresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ware" do
    assert_difference("Ware.count") do
      post wares_url, params: { ware: { name_product: @ware.name_product, price: @ware.price } }
    end
  ...
  test "should update ware" do
    patch ware_url(@ware), params: { ware: { name_product: @ware.name_product, price: @ware.price } }
